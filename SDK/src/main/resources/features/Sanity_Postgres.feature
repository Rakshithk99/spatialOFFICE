...
Feature: To Validate the Sanity Tests for SDK Application
  ...
  Scenario Outline: To Create the KML Layer and validate the layer is created
    ...
    Examples:
      | DB                                    | path                          |
      | http://10.246.4.94/Postgres/SHAW01_SO | C:\Third Party Layers\KML.kml |
  ...
  Scenario Outline: To Create the KMZ Layer and validate the layer is created
    ...
    Examples:
      | DB                                    | path                          |
      | http://10.246.4.94/Postgres/SHAW01_SO | C:\Third Party Layers\KMZ.kmz |
  ...
  Scenario Outline: To validate the Jobs Tab,Search and Details
    ...
    Examples:
      | DB                                    | ID         | BOOKMARK     |
      | http://10.246.4.94/Postgres/SHAW01_SO | R229260882 | Storage Loop |
  ...
  Scenario Outline: To Validate the Trace from Main Menu
    ...
    Examples:
      ...
      | http://10.246.4.94/Postgres/SHAW01_SO | R229260882 | 300        | 1      |
  ...
  Scenario Outline: To Validate the Rf Power from Main Menu
    ...
    Examples:
      | DB                                    | ID       |
      | http://10.246.4.94/Postgres/SHAW01_SO | PS744733 |
  ...
  Scenario Outline: To Validate the Splicing
    ...
    Examples:
      | DB                                    | ID         |
      | http://10.246.4.94/Postgres/SHAW01_SO | SC10014626 |
  ...
  Scenario Outline:To validate the Trace Report from Reports Dropdown
    ...
    Examples:
      ...
      | http://10.246.4.94/Postgres/SHAW01_SO | PLEC10033103 | 5           | 10      |
  ...
  Scenario Outline:To validate the Splice Report from Reports Dropdown
    ...
    Examples:
      | DB                                    | ID         |
      | http://10.246.4.94/Postgres/SHAW01_SO | SC10014711 |
  ...
  Scenario Outline:To validate the Equipment Report from Reports Dropdown
    ...
    Examples:
      | DB                                    | ID       |
      | http://10.246.4.94/Postgres/SHAW01_SO | 10400223 |

  Scenario Outline:To validate the Address List Report
    Given I launch <DB> the Application
    When  I enter the Credentials
    Given I verify the Map Section
    Then  I Click on the reports dropdown
    ...
    Examples:
      | DB                                    | ID        |
      | http://10.246.4.94/Postgres/SHAW01_SO | 593011783 |
...
#    Given  I Log out
  ...
  Scenario Outline: To Validate the SpatialOffice with the URl to search with address
    ...
    Examples:
      | DB                                                                                                                                               |
      | http://10.246.4.94/Postgres/SHAW01_SO/#/map(sidebar:sidebar)?selectedTab=search&searchText=6764 S River Rd, Marine City, MI 48039, United States |
